          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h3 class="card-title">{{ $articles_blog->title }}</h3>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                            <div class="text-center">
                                <img src="{{ asset('storage/article/' . $articles_blog->image) }}" width="60%" alt="image"class="img-thumbnail img-preview">
